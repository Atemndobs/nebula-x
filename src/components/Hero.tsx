...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[calc(100vh-2rem)] flex items-start justify-center bg-black -mt-24">
      ...
      {/* Hero Card */}
      <div className="container mx-auto px-28 h-[calc(100vh-2rem)] pt-12 mb-8">
        <div className="relative bg-gradient-to-br from-[#1a0a2e]/90 via-[#1a0a2e]/85 to-[#3a0a3e]/80 backdrop-blur-xl border border-white/5 rounded-3xl overflow-hidden shadow-2xl h-full flex flex-col">
          ...
          <div className="relative z-10 flex-1 flex flex-col p-8 md:px-12 lg:px-16 pt-12">
              ...
              <div className="flex justify-center mb-10">
                <div className="flex -space-x-3 overflow-hidden">
                  {[
                    ...
                    <div key={index} className="inline-block h-16 w-16 rounded-full border-3 border-[#1a0a2e] bg-gray-800 overflow-hidden">
                      <img
                        src={src}
